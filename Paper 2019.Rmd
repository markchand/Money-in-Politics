...
*Add Barber Summary*
*Test Barber correlations?* Maybe not necessary 
<!--Add in summary statistics here. Plot of something over time? Histograms? Correlations? -->
```{r Barber summary}
descr(Barber)
# Barber histograms 
...
convictions.plot
# FAIL convictions.time <- ggplot(convictions, aes(Year,CCI)) + stat_summary(fun.y = sum) + theme_minimal()
```
...
\newpage
##Appendix B: Descriptions of Control Variables
