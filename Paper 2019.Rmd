...
```{r modeling of CCI base model effects, eval=F}
...
```{r modeling of CRI base model effects, eval=F}
# Base model with no fixed or random effects 
...
```{r output of CRI base model effects, eval=F}
...
```{r modeling of CCI with campaign finance variables, eval=F}
# Base model with no fixed or random effects 
...
```{r output of CCI with campaign finance variables, eval=F}
...
```{r modeling of CRI with campaign finance variables, eval=F}
# Base model with no fixed or random effects 
...
```{r output of CRI with campaign finance variables, eval=F}
...
```{r CCI output to table}
stargazer(cci.base.pooled, 
          cci.limits.pooled, 
          cci.limits.fixed,
          cci.limits.fixed.time, 
          type="text",
          title = "Are the presence or amounts of campaign limits correlated with corruption convictions?",
...
```{r CRI output to table}
stargazer(cri.base.pooled, 
          cri.limits.pooled, 
          cri.limits.fixed,
          cri.limits.fixed.time, 
          type="text",
          title = "Are the presence or amounts of campaign limits correlated with the Corruption Reflections Index?",
...
```{r (old) controlled panel modeling, eval=F}
...
```{r controlled panel modeling, eval=F}
...
```{r post-Lentz panel effects modeling 1, eval=F}
...
```{r stargazer controlled panel, eval=F}
