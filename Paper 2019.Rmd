...
[^SPSA]: Working paper presented at the Annual Meeting of the Southern Political Science Association, January 2019.
...
The final set of models (Table X) displays results from multiple first difference models designed to isolate the effect of changes in campaign finance laws on corruption arrests. None of the models find correlation between campaign finance limits and either corruption convictions or corruption reflections. 
