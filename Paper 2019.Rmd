...
```{r Barber summary statistics fail, results="asis", eval=TRUE}
# This is what fails to knit (see error below)
stargazer(as.data.frame(subset(BarberNAs[,3:6])), digits=0, type="latex", title="Descriptive Statistics for State Level Campaign Finance Limits (n=1150 state-years)", covariate.labels = c("Individual Limits","Individual-to-Party Limits","Party Limits", "PAC Limits"), header=F)
```
...
```{r CRI summary, results="asis", eval=T}
...
```{r Empty, Binomial, and Poisson models}
