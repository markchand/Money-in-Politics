...
Barber <- read_csv("~/Dropbox/PhD_data/MiP/data/Barber/Barber Limits Data.csv")
...
convictions <- read_csv("~/Dropbox/PhD_data/MiP/data/ICS/CCI19762015.csv")
perceptions <- read_csv("~/Dropbox/PhD_data/MiP/data/ICS/CPS20142016.csv")
#Doesn't havetime series data 
reflections <- read_csv("~/Dropbox/PhD_data/MiP/data/ICS/CRI19772013.csv")
