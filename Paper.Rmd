...
The final set of models (Table 4) displays results from multiple difference-in-difference models designed to isolate the effect of changes in campaign finance laws on corruption arrests. None of the models find correlation between campagin finance limits and either corruption convictions or corruption reflections. 
