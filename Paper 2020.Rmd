...
```{r Barber summary stats latex, results="asis",eval=T,include=F}
...
$(log)Convictions = \alpha_{state} + \beta_{1}{indiv.dummy} + \beta_{2}{indiv.dummy}*{indiv.limit} + \beta_{3}{pac.dummy} + \beta_{4}{pac.dummy}*{pac.limit} + \beta_{5}{indiv-to-party.dummy} + \beta_{6}{indiv-to-party.dummy}*{indiv-to-party.limit} + Controls + \epsilon$

#### Corruption Reflections Index versus campaign contributions in a given state-year: 
$(log)Reflections = \alpha_{state} + \beta_{1}{indiv.dummy} + \beta_{2}{indiv.dummy}*{indiv.limit} + \beta_{3}{pac.dummy} + \beta_{4}{pac.dummy}*{pac.limit} + \beta_{5}{indiv-to-party.dummy} + \beta_{6}{indiv-to-party.dummy}*{indiv-to-party.limit} + Controls + \epsilon$
...
stargazer(
  ...
  covariate.labels=c("Individual limit (amount)",
                     ...
                     # "% high school grads",
                     # "Govt revenues/capita ($1000s)",
                     # "Urbanization",
                     # "Log of population (MMs)"),
  add.lines = list(c(" ","Base Model","With IVs","Pooled","FE"))
  )
